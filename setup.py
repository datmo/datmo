...
if sys.version_info[0] < 3:  # python 2
    prerequisites = [
        ...
        "pyyaml>=3.12", "pytz>=2017.3", "tzlocal>=1.5.1", "chardet==3.0.2",
        "urllib3==1.21.1", "requests==2.19.1", "prettytable>=0.7.2", "rsfile>=2.1",
        ...
        "itsdangerous>=0.24", "six>=1.8.0", "wsgiref>=0.1.2"
    ]
else:  # python 3
    prerequisites = [
        "future>=0.16.0", "enum34>=1.1.6", "glob2>=0.5", "docker>=2.2.1",
        "chardet==3.0.2", "pyyaml>=3.12", "pytz>=2017.3", "tzlocal>=1.5.1",
        "urllib3==1.21.1", "requests==2.19.1", "prettytable>=0.7.2",
