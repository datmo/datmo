...
if sys.version_info[0] < 3:  # python 2
    prerequisites = [
        ...
        "urllib3==1.21.1",  "chardet==3.0.2"
    ]
else:  # python 3
    prerequisites = [
        "future>=0.16.0", "enum34>=1.1.6", "glob2>=0.5", "docker>=2.2.1",
        "pyyaml>=3.12", "pytz>=2017.3", "tzlocal>=1.5.1", "requests==2.19.1",
        ...
        "flask>=0.10.1", "jinja2>=2.7.3", "markupsafe>=0.23",
        "werkzeug>=0.9.6", "beautifulsoup4>=4.3.2", "gunicorn>=19.1.1",
        "itsdangerous>=0.24", "six>=1.8.0",  "urllib3==1.21.1",
        "chardet==3.0.2", "prettytable>=0.7.2"
    ]
