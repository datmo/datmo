...
class TaskController(BaseController):
    ...
    def run(self, task_id, snapshot_dict=None, task_dict=None):
        ...
        before_snapshot_dict['message'] = "autogenerated snapshot created before task %s is run" % task_obj.id
        ...
        after_snapshot_dict['message'] = "autogenerated snapshot created after task %s is run" % task_obj.id
