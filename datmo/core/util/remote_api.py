...
class RemoteAPI():
    ...
    def post_data(self, input_data):
        ...
        try:
            ...
            r = requests.post(self.post_meta_data_endpoint,
    ...
    def get_data(self, filter):
        ...
        try:
            ...
            r = requests.get(self.get_meta_data_endpoint, params=filter, headers=headers)
            response = {'status_code': r.status_code, 'body': r.json()}
        except:
            response['status_code'] = 500
        return response
    ...
    def update_actual(self, id, actual):
        ...
        try:
            ...
            r = requests.put(self.put_meta_data_endpoint,
    ...
    def get_deployment_info(self):
        ...
        try:
            ...
            r = requests.get(self.get_deployment_info_endpoint,
