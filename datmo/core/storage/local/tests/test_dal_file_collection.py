...
class TestLocalDAL():
    ...
    def test_create_file_collection_by_dictionary(self):
        ...
        assert file_collection.driver_type == self.file_collection_input_dict['driver_type']
        assert file_collection.filehash == self.file_collection_input_dict['filehash']
    ...
    def test_update_file_collection(self):
        ...
        updated_file_collection = self.dal.file_collection.update(updated_file_collection_input_dict)
        assert file_collection.id == updated_file_collection.id
        assert file_collection.updated_at < updated_file_collection.updated_at
        assert updated_file_collection.driver_type == updated_file_collection_input_dict['driver_type']
