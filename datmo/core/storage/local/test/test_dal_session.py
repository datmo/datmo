...
class TestLocalDAL():
    ...
    def test_create_session_by_dictionary(self):
        session = self.dal.session.create(self.session_input_dict)
        ...
        session_2 = self.dal.session.create(self.session_input_dict)
        ...
        session_3 = self.dal.session.create(test_session_input_dict)
