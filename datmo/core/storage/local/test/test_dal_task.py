...
class TestLocalDAL():
    ...
    def test_sort_tasks(self):
        ...
        items = self.dal.task.query({"model_id": self.task_input_dict["model_id"]},
        ...
        failed = False
        try:
            _ = self.dal.task.query({"model_id": self.task_input_dict["model_id"]},
        ...
        expected_items = self.dal.task.query({"model_id": self.task_input_dict["model_id"]},
                                             sort_key='created_at', sort_order='ascending')
        items = self.dal.task.query({"model_id": self.task_input_dict["model_id"]},
